...
from crowdpact.apps.pact.api import (
    EndingSoonPactList, MakePledgeView, MostPopularPactList, NewestPactList, PactDetailsView
)
...
urlpatterns = [
    ...
    url(r'^api/make-pledge?$', MakePledgeView.as_view(), name='pact.api.make_pledge'),
]
